...
- **93% precision, 91% recall** on hard cuts (movie clip)
- **88% accuracy** on lighting-change events (security/camera footage)

---

## Known Limitations

- Fast camera pans can trigger false positives (similar visual change as a scene cut)
